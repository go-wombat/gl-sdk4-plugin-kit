...
const MANIFEST_KEYS = Object.freeze([
  '$schema', 'schemaVersion', 'id', 'profile', 'package', 'compatibility', 'overlay', 'lifecycle',
]);
const PACKAGE_KEYS = Object.freeze([
  'name', 'architecture', 'section', 'source', 'description', 'depends', 'conffiles',
]);
const COMPATIBILITY_KEYS = Object.freeze(['minimumFirmware', 'requiredComponents']);
...
function validateCompatibility(value) {
  ...
  return { minimumFirmware, requiredComponents };
}
