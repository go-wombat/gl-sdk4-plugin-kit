...
const COMMAND_HELP = Object.freeze({
  ...
  deploy: 'glplugin deploy [target|host] [--build] [--insecure-host-key]',
  install: 'glplugin install [target|host] [--no-build] [--insecure-host-key]',
  uninstall: 'glplugin uninstall [target|host] [--insecure-host-key]',
  dev: 'glplugin dev [target|host] [--debounce <ms>] [--insecure-host-key]',
  doctor: 'glplugin doctor [target|host] [--https|--http] [--insecure|--secure] [--username <name>] [--password-stdin]',
  test: 'glplugin test [target|host] [--https|--http] [--insecure|--secure] [--username <name>] [--password-stdin]',
